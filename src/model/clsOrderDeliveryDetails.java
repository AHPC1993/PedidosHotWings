 ...
 * @author GSG
 */
public class clsOrderDeliveryDetails {
    ...
    public clsOrderDeliveryDetails() {
    }

    public clsOrderDeliveryDetails(String order_number, String product_id, String additional_products_id, String customers_id, String product_name, String product_description, double product_price, double product_amount, double product_price_total, String notes, String search, String localOrder_id) {
